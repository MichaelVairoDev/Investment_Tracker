                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('portfolios.update', $portfolio) }}" method="POST">
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('portfolios.show', $portfolio) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancelar
                            </a>
