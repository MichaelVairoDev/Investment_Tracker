    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Transacciones - {{ $investment->name }} ({{ $investment->symbol }})
            </h2>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            <div class="text-sm font-medium text-gray-500">Cantidad Total</div>
                            <div class="mt-1 text-2xl font-semibold text-gray-900">
                                {{ number_format($investment->quantity, 6) }}
                            </div>
                        </div>
                        <div>
                            <div class="text-sm font-medium text-gray-500">Precio Actual</div>
                            <div class="mt-1 text-2xl font-semibold text-gray-900">
